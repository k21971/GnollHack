...
NHSUBDIR="gnollhack-4.1.3.16"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/gnollhack-4.1.3.16"
# END OF CONFIG
##############################################################################
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-gnoll41316"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-gnoll41316"
