...
NHSUBDIR="gnollhack-4.1.0.27"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/gnollhack-4.1.0.27/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-gnoll410b7"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-gnoll410b7"
